...
from src.Util.Util import get_images
...
def pie():
    image_list_train, artist_list_train = get_images("../dataset/mat/train_artist.mat", "artists")
    image_list_test, artist_list_test = get_images("../dataset/mat/test_artist.mat", "artists")

    _, movement_list_train = get_images("../dataset/mat/train_movement.mat", "movements")
    _, movement_list_test = get_images("../dataset/mat/test_movement.mat", "movements")
