...
def prepare_data(isAugmented=False):
    ...
    io.savemat(f"train_artist.mat", train_artist)
    ...
    io.savemat(f"test_artist.mat", test_artist)
    ...
    io.savemat(f"train_movement.mat", train_movement)
    ...
    io.savemat(f"test_movement.mat", test_movement)
...
def extract_features_movement():
    ...
    io.savemat(f"train_movement.mat", train_artist)
    ...
    io.savemat(f"test_movement.mat", test_artist)
